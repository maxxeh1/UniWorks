...
public class SingleQueue implements IManager
{
	private Queue queue;
    ...
    {
    	String player1 = (String)queue.deQ();
    	String player2 = (String)queue.deQ();
    ...
    public void setMatchWinner(boolean player1)
    {
    	if(player1)
    	{
    		queue.enQ(current.player1);
    	}
    	else
    	{
    		queue.enQ(current.player2);
    	}
    }
